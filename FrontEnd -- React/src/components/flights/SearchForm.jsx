...
function SearchForm() {
    ...
    return (
        <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl max-w-7xl mx-auto mt-6 mb-8 border border-sky-200/50 overflow-visible" style={{ fontFamily: "'Inter', ui-sans-serif, system-ui, sans-serif" }}>
            ...
            <div className="bg-gradient-to-r from-sky-50/80 to-blue-50/80 backdrop-blur-sm rounded-xl mx-6 mb-8 border border-sky-200/60 shadow-lg overflow-visible">
                {/* Desktop Layout */}
                ...
                <div className="lg:hidden p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {/* From Field */}
                        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-sky-200/60 hover:bg-white/90 transition-all duration-300">
                            <label className="block text-xs font-semibold text-sky-700 mb-1 uppercase tracking-wide">From</label>
                            <div className="relative">
                                <input
                                    type="text"
                        ...
                        {/* To Field */}
                        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-sky-200/60 hover:bg-white/90 transition-all duration-300 relative overflow-visible">
                            <label className="block text-xs font-semibold text-sky-700 mb-1 uppercase tracking-wide">To</label>
                            <div className="relative">
                                <input
                                    type="text"
                    ...
                    {/* Swap Button - Centered between From/To on mobile */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Return Date */}
                        <div className={`bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-sky-200/60 hover:bg-white/90 transition-all duration-300 ${typeTrip === 'oneWay' ? 'opacity-50' : ''}`}>
                            <label className="block text-xs font-semibold text-sky-700 mb-1 uppercase tracking-wide">Return</label>
                            <div className="relative flex items-center">
                                <input
                                    type="date"
                    ...
                    <div className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 transition-all duration-300 rounded-2xl shadow-lg">
                        <button
                            className="w-full px-8 py-4 text-white font-bold text-base disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center hover:scale-105 transition-transform duration-200"
                            onClick={handleSearch}
                            disabled={isLoading || !isFormValid()}
                        >
                            {isLoading ? (
