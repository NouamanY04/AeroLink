    ...
    if (type && type === 'api') {
        newData = data.map((item) => {
            return {
                ...
                date_depart: item.departure_time.split(" ")[0],
                heure_depart: item.departure_time.split(" ")[1].slice(0, 5),
                date_Arrive: item.arrival_time.split(" ")[0],
                heure_arrive: item.arrival_time.split(" ")[1].slice(0, 5),
