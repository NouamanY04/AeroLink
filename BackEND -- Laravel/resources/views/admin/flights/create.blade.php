...
<div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-8">
    ...
    <form action="{{ route('flights.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="flight_number" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required value="{{ old('flight_number') }}">
        ...
        <div class="mb-4">
            ...
            <select name="departure_airport_id" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required>
                ...
                @foreach($airports as $airport)
                    <option value="{{ $airport->id }}" {{ old('departure_airport_id') == $airport->id ? 'selected' : '' }}>{{ $airport->code }} - {{ $airport->name }}</option>
                @endforeach
            </select>
        ...
        <div class="mb-4">
            ...
            <select name="arrival_airport_id" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required>
                ...
                @foreach($airports as $airport)
                    <option value="{{ $airport->id }}" {{ old('arrival_airport_id') == $airport->id ? 'selected' : '' }}>{{ $airport->code }} - {{ $airport->name }}</option>
                @endforeach
            </select>
        ...
        <div class="mb-4">
            ...
            <input type="datetime-local" name="departure_time" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required value="{{ old('departure_time') }}">
        ...
        <div class="mb-4">
            ...
            <input type="datetime-local" name="arrival_time" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required value="{{ old('arrival_time') }}">
        ...
        <div class="mb-4">
            ...
            <input type="number" step="0.01" name="price" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required value="{{ old('price') }}">
            @error('price')<div class="text-red-500 text-sm">{{ $message }}</div>@enderror
        </div>
        <div class="mb-4">
            <label class="block text-gray-700">Seats Total</label>
            <input type="number" name="seats_total" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required value="{{ old('seats_total') }}">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="seats_available" class="mt-1 block w-full border-gray-300 rounded shadow-sm" required value="{{ old('seats_available') }}">
